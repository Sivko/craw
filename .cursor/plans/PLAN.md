...
| 3 | Настройка Redis Streamer для real-time обновлений | pending |
| 4 | Реализация авторизации (Telegram MiniApp + гостевой вход) | pending |
| 5 | Модуль комнат с настройками (сложность, таймер) | pending |
| 6 | Игровая логика (матчи, выбор слов, ротация художника) | pending |
| 7 | Модуль чата с историей сообщений | pending |
| 8 | Модуль рисунков с сохранением в WebP | pending |
